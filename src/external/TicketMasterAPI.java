...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "mG9FueIKu5GnSaA1RD8RMro0EnsbmoJm";
    public List<Item> search(double lat,double lon,String keyword) {
        ...
        try {
        	...
        	int responseCode=connection.getResponseCode(); //process response message header
			...
			BufferedReader reader = new BufferedReader(new InputStreamReader(connection.getInputStream()));//process response message body
			String line;
